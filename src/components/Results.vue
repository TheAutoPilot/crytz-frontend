        ...
        <v-row>
          <v-col md="6">
            <div class="d-flex justify-center">
              <v-img
                :src="`http://0.0.0.0:8887/v_output/${results.video_name}.gif`"
                :lazy-src="`http://0.0.0.0:8887/v_output/${results.video_name}.gif`"
                aspect-ratio="1"
                height="530"
                width="720"
            ...
            <div class="text-lg-h6">Click the download button to download the prediction file</div>
              <div class="d-flex justify-center">
                <div class="download" :style="{ backgroundColor: backColor, }">
                    <div class="d-flex justify-center">
                      <a :href="'http://0.0.0.0:8887/videos/'+results.video_fn">
